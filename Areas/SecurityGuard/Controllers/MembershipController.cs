...
using GrouponJobsMVC.Controllers;
using viewModels = GrouponJobsMVC.Areas.SecurityGuard.ViewModels;

namespace GrouponJobsMVC.Areas.SecurityGuard.Controllers
{
